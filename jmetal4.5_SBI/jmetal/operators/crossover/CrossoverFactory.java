...
public class CrossoverFactory {
  ...
  public static Crossover getCrossoverOperator(String name, HashMap parameters) throws JMException {
    ...
    else if (name.equalsIgnoreCase("SinglePointCrossover_DPR"))
        return new SinglePointCrossover_DPR(parameters);
    else if (name.equalsIgnoreCase("SinglePointCrossover_DPR_MC"))
        return new SinglePointCrossover_DPR_MC(parameters);
    else if (name.equalsIgnoreCase("SinglePointCrossover_TestCases"))
        return new SinglePointCrossover_TestCases(parameters);
    else if (name.equalsIgnoreCase("SinglePointCrossover_Generation_DPR"))
        return new SinglePointCrossover_Generation_DPR(parameters);
