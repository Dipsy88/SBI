...
public class BLXAlphaCrossover extends Crossover {
	...
	/**
	 * Constructor Create a new SBX crossover operator whit a default index given by
	...
	public Object execute(Object object) throws JMException {
		...
		if (!(VALID_TYPES.contains(parents[0].getType().getClass())
			...
			Configuration.logger_.severe("BLXAlphaCrossover.execute: the solutions " + "type " + parents[0].getType()
