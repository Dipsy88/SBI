...
public class SBXSinglePointCrossover extends Crossover {
	 ...
	 */
	public Solution[] doCrossover(Double realProbability, Double binaryProbability, Solution parent1, Solution parent2)
			throws JMException {
	...
	public Object execute(Object object) throws JMException {
		...
		if (!(VALID_TYPES.contains(parents[0].getType().getClass())
			...
			Configuration.logger_.severe("SBXSinglePointCrossover.execute: the solutions " + "type "
		...
		Solution[] offSpring;
		offSpring = doCrossover(realCrossoverProbability_, binaryCrossoverProbability_, parents[0], parents[1]);
