...
public abstract class Algorithm implements Serializable {
	 ...
	 * @throws Exception
	 */
	public abstract SolutionSet execute() throws JMException, ClassNotFoundException, Exception;

	/**
	 * Offers facilities for add new operators for the algorithm. To use an
	 * operator, an algorithm has to obtain it through the <code>getOperator</code>
	 * method.
	 * 
	 * @param name
	 *            The operator name
	...
	/**
	 * Sets an input parameter to an algorithm. Typically, the method is invoked by
	 * a Main object before running an algorithm. The parameters have to been
	...
	/**
	 * Gets an input parameter through its name. Typically, the method is invoked by
	 * an object representing an algorithm
	 * 
	 * @param name
	 *            The parameter name
