...
public class Solution implements Serializable {
	...
	// Added by dipesh
	private String[] cases_;
	private double normDistance;
	private double weightObj;
	private List<TestCase> caseList = new ArrayList<TestCase>();
	private List<TestCase> selectedCaseList = new ArrayList<TestCase>();
	// for test case implantation
	...
	public void setSelectedCaseList(List<TestCase> selectedCaseList) {
		this.selectedCaseList = selectedCaseList;
	}

	public Map<String, TestCase> caseMap = new HashMap<String, TestCase>();
	...
	public void setCases_(String[] cases_) {
		this.cases_ = cases_;
	}
	...
	// Dipesh
	public Solution(Problem problem, double[] values)
			throws ClassNotFoundException {
		problem_ = problem;
		type_ = problem.getSolutionType();
		numberOfObjectives_ = problem.getNumberOfObjectives();
		...
		// variable_ = problem.solutionType_.createVariables() ;
		variable_ = type_.createVariables(values);
	} // Solution
	...
	public Solution(Solution solution) {
		...
		this.caseList = cloner.deepClone(solution.getCaseList());
		this.selectedCaseList = cloner
				.deepClone(solution.getSelectedCaseList());

		if (solution.cases_ != null) {
			// dipesh
			// cases_ = new String[solution.cases_.length];
			// for (int i = 0; i < solution.cases_.length;i++) {
			// cases_[i] = new String(solution.getCases(i));
			// }
			// caseList = solution.getCaseList();
		}
	} // Solution
	...
	// Dipesh
	public double getNormDistance() {
		return normDistance;
	}

	public void setNormDistance(double normDistance) {
