...
public abstract class Operator implements Serializable {
	...
	/**
	 * Abstract method that must be defined by all the operators. When invoked, this
	 * method executes the operator represented by the current object.
	 * 
	 * @param object
	 ...
	 * @throws Exception
	 */
	abstract public Object execute(Object object) throws JMException, Exception;

	public void setIndex(int index) {

	}

	abstract public Object executeProblem(Object object, Problem problem) throws JMException, Exception;
