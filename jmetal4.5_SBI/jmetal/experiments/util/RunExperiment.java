...
public class RunExperiment extends Thread {
	...
	public RunExperiment(Experiment experiment, HashMap<String, Object> map, int id, int numberOfThreads,
	...
	public void run() {
		...
		while (!finished) {
			...
			if (!finished && problemData != null) {
				...
				System.out.println(Thread.currentThread().getName() + " Running algorithm: " + algorithmNameList_[alg]
						+ ", problem: " + problemList_[problemId] + ", run: " + runs);
				try {
