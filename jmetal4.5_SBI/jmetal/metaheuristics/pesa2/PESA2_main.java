...
public class PESA2_main {
	 ...
	 *             Usage: three options - jmetal.metaheuristics.mocell.MOCell_main -
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * crossover.setParameter("probability",0.9); mutation =
		 * MutationFactory.getMutationOperator("BitFlipMutation");
