...
/**
 * This class represents the original asynchronous MOCell algorithm hybridized
 * with Diferential evolutions (GDE3), called CellDE. It uses an archive based
 * on spea2 fitness to store non-dominated solutions, and it is described in:
