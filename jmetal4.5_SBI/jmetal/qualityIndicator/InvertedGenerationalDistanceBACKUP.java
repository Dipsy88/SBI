 ...
 *            Inst. Technol. (1998)
 */
public class InvertedGenerationalDistanceBACKUP {
  ...
  static String [] algorithmNameList_ = new String[] {"ea", "nsgaii", "spea2", "cellde", "ibea", "mocell", "avm","rs", "ga"};
   ...
   */
  public InvertedGenerationalDistanceBACKUP() {
 ...
 * @throws Exception 
	...
	for (int algorithmIndex=0; algorithmIndex<algorithmNameList_.length; algorithmIndex++) {
		...
		for (int row=1;row<=100;row++){
			 for (int column=1;column<76;column++){
				    ...
				    InvertedGenerationalDistanceBACKUP qualityIndicator = new InvertedGenerationalDistanceBACKUP();
  ...
  public static double [][] readFile(int row, int column, String algorithm){		
	...
	public static void createFile(String algorithm) throws Exception{
		fileName = new File("/Users/Dipesh/OneDrive/Papers/ICST2015/Analysis/"+numberCases+"/IGD/" + algorithm+ ".txt");
