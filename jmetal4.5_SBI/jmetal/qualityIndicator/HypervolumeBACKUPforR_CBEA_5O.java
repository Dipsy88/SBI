 ...
 *           pp. 257-271, 1999.
 */
public class HypervolumeBACKUPforR_CBEA_5O {
...
//  private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/ICST_2016/Analysis/Kongsberg/HV/paes";
  ...
  private static String inFolderNSGAII = "/Users/Dipesh/Documents/workspace/ICST_Experiments_Prioritization_NoBudget/output/cisco2/test/HV/cbea";
  private static String outFolderNSGAII = "/Users/Dipesh/Documents/workspace/ICST_Experiments_Prioritization_NoBudget/output/cisco2/HV/test";
...
// static String []  algorithmNameList_ = new String[] {"CELLDE","EA"};
  ...
  */
  public HypervolumeBACKUPforR_CBEA_5O() {
  ...
  public static void main(String args[]) throws Exception {
	  for (int algorithmRun=0;algorithmRun<algorithmNameList_.length;algorithmRun++){
			...
			for (int row=1;row<52;row++){			
				    ...
				    HypervolumeBACKUPforR_CBEA_5O qualityIndicator = new HypervolumeBACKUPforR_CBEA_5O();
...
//	   System.out.println("/Users/Dipesh/OneDrive/Papers/ICTSS_2016/Anaylsis/"+numberCases+"/NoBudget/20/"+algorithm+"/"+algorithm+row);
	...
	//		    		break;
			    	...
			    	if (solutionFront[i][0]==0 || solutionFront[i][1] == 0 || solutionFront[i][2] == 0 || solutionFront[i][3] == 0 || solutionFront[i][4] == 0)
			    		break;
