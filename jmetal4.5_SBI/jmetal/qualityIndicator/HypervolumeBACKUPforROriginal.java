 ...
 *           pp. 257-271, 1999.
 */
public class HypervolumeBACKUPforROriginal {
...
// static String []  algorithmNameList_ = new String[] {"CELLDE","IBEA", "MOCELL","NSGAII","SPEA2","SMPSO"};
 static String []  algorithmNameList_ = new String[] {"SPEA2"};


// static String []  algorithmNameList_ = new String[] {"CELLDE","EA"};
//  static int numberCases = 4;
  
  /**
  * Constructor
  * Creates a new instance of MultiDelta
  */
  public HypervolumeBACKUPforROriginal() {
 ...
 * @throws Exception 
  ...
  public static void main(String args[]) throws Exception {
			...
			for (int row=21;row<=100;row++){
				 for (int column=1;column<=75;column++){
				    ...
				    */
				    ...
				    HypervolumeBACKUPforROriginal qualityIndicator = new HypervolumeBACKUPforROriginal();
	...
	public static double [][] readFile(int row, int column, String algorithm){		
	    ...
	    double [][] trueFront;
	    int counter;
	   // System.out.println("/Users/Dipesh/OneDrive/Papers/ICST2015/Result/new/165a/"+algorithm+"/"+algorithm + column + "_" + row);
			try {
			    BufferedReader in = new BufferedReader(new FileReader("/Users/Dipesh/OneDrive/Papers/ICST2015/Result/new/165a/"+algorithm+"/"+algorithm + column + "_" + row));
	...
	public static void createFile(String algorithm) throws Exception{
		fileName = new File("/Users/Dipesh/OneDrive/Papers/ICST2015/Analysis/new/165a/"+"Hypervolume/forR/"+algorithm+ ".txt");
