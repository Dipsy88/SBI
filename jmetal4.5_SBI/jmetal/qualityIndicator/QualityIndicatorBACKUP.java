...
//		problemcount = 1456;
		...
		algorithmNameList_ = new String[] {"smpso", "nsgaii", "spea2", "cellde", "ibea", "mocell", "ea", "avm","rs","ga","greedy"};
...
//			System.out.println(i);
	...
	private void generateReferenceFront(int problemIndex)
	{
		...
		String frontPath_ = referenceFrontDirectory + String.valueOf(problemIndex);
		...
		for (int algorithmIndex=0; algorithmIndex<algorithmNameList_.length; algorithmIndex++) {
			...
			for (int numRun=1; numRun<=independentRuns_; numRun++) {
				...
				outputParetoFrontFilePath = "/Users/Dipesh/OneDrive/Papers/JournalShuai/Analysis/solutionFront/" + algorithmNameList_[algorithmIndex] + problemIndex + "_" + numRun;
