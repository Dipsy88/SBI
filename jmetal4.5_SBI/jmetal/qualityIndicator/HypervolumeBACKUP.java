 ...
 *           pp. 257-271, 1999.
 */
public class HypervolumeBACKUP {

  public jmetal.qualityIndicator.util.MetricsUtil utils_;
  private static File fileName;
  private static BufferedWriter file;
  
 //static String []  algorithmNameList_ = new String[] {"AVM","CELLDE","EA","IBEA", "MOCELL","NSGAII","SMPSO","SPEA2","PAES"};
 ...
 * @throws Exception 
  ...
  public static void main(String args[]) throws Exception {
			...
			for (int row=1;row<101;row++){
				 for (int column=1;column<76;column++){
				    ...
				    */
				    ...
				    HypervolumeBACKUP qualityIndicator = new HypervolumeBACKUP();
	...
	public static void createFile(String algorithm) throws Exception{
		fileName = new File("/Users/Dipesh/OneDrive/Papers/ICST2015/Analysis/"+numberCases+"/Hypervolume/original/"+algorithm+ ".txt");
