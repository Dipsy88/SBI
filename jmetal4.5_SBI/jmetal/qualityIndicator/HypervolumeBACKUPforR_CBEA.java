 ...
 *           pp. 257-271, 1999.
 */
public class HypervolumeBACKUPforR_CBEA {
...
//private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/ICST_2016/Result/hv/own";
  
//  private static String inFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/ICST_2016/Result/Kongsberg/paes/paes";
//  private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/ICST_2016/Analysis/Kongsberg/HV/paes";
  
  private static String inFolderNSGAII = "/Users/Dipesh/Documents/workspace/ICST_Experiments_Prioritization_NoBudget/output/kongsberg/spea2/HV/spea2";
  private static String outFolderNSGAII = "/Users/Dipesh/Documents/workspace/ICST_Experiments_Prioritization_NoBudget/output/kongsberg/HV/spea2";
...
// static String []  algorithmNameList_ = new String[] {"CELLDE","EA"};
  static int numberCases = 489;
  
  /**
  * Constructor
  * Creates a new instance of MultiDelta
  */
  public HypervolumeBACKUPforR_CBEA() {
  ...
  public double hypervolume(double [][] paretoFront, 
     ...
     */
    double[] maximumValues={1,1,1,1};
    
    /**
     * Stores the minimum values of the true pareto front.
     */
    double[] minimumValues={0,0,0,0};
 ...
 * @throws Exception 
  ...
  public static void main(String args[]) throws Exception {
	  for (int algorithmRun=0;algorithmRun<algorithmNameList_.length;algorithmRun++){
			...
			for (int row=1;row<481;row++){			
					  double [][] solutionFront =readFile(row,algorithmNameList_[algorithmRun] );
					  int numberObjectives = 4;
	
				    //Create a new instance of the metric
				    HypervolumeBACKUPforR_CBEA qualityIndicator = new HypervolumeBACKUPforR_CBEA();
	...
	public static double [][] readFile(int row,String algorithm){		
		double [][] solutionFront = new double[100][4] ;
	    double [][] trueFront;
	    int counter;
//	   System.out.println("/Users/Dipesh/OneDrive/Papers/ICTSS_2016/Anaylsis/"+numberCases+"/NoBudget/20/"+algorithm+"/"+algorithm+row);
	...
	//		    		break;
			    	...
			    	if (solutionFront[i][0]==0 || solutionFront[i][1] == 0 || solutionFront[i][2] == 0|| solutionFront[i][3] == 0)
			    		break;
