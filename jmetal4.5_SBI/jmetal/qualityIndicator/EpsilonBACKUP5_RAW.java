...
public class EpsilonBACKUP5_RAW {
...
//	  static String [] algorithmNameList_ = new String[] {"ea", "nsgaii", "spea2", "cellde", "ibea", "mocell", "avm"};
	  static String [] algorithmNameList_ = new String[] {"ga","rs"};
//	  
  /**
    ...
    for (int algorithmIndex=0; algorithmIndex<algorithmNameList_.length; algorithmIndex++) {
		...
		for (int row=1;row<=100;row++){
			 for (int column=1;column<76;column++){
				    EpsilonBACKUP5_RAW qualityIndicator = new EpsilonBACKUP5_RAW();
...
public static void createFile(String algorithm) throws Exception{
		fileName = new File("/Users/Dipesh/OneDrive/Papers/ICST2015/Analysis/RAW/"+numberCases+"/epsilon/" + algorithm+ ".txt");
