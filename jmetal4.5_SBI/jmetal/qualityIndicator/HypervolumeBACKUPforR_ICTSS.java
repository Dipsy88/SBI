 ...
 *           pp. 257-271, 1999.
 */
public class HypervolumeBACKUPforR_ICTSS {
...
// static String []  algorithmNameList_ = new String[] {"CELLDE","IBEA", "MOCELL","NSGAII","SPEA2","SMPSO"};
 static String []  algorithmNameList_ = new String[] {"nsgaii","rs"};
...
// static String []  algorithmNameList_ = new String[] {"CELLDE","EA"};
  ...
  */
  public HypervolumeBACKUPforR_ICTSS() {
  ...
  public static void main(String args[]) throws Exception {
	  for (int algorithmRun=0;algorithmRun<algorithmNameList_.length;algorithmRun++){
			...
			for (int row=1;row<11;row++){			
				    ...
				    HypervolumeBACKUPforR_ICTSS qualityIndicator = new HypervolumeBACKUPforR_ICTSS();
...
//	   System.out.println("/Users/Dipesh/OneDrive/Papers/ICTSS_2016/Anaylsis/"+numberCases+"/NoBudget/20/"+algorithm+"/"+algorithm+row);
			try {
			    BufferedReader in = new BufferedReader(new FileReader("/Users/Dipesh/OneDrive/Papers/ICTSS_2016/Result/Budget/50/My/"+algorithm+"/"+algorithm+row));
			    String str;
			    int i=0;
...
//			    	solutionFront[i][8] =Double.parseDouble(details[8]);
	...
	public static void createFile(String algorithm) throws Exception{
		fileName = new File("/Users/Dipesh/OneDrive/Papers/ICTSS_2016/Analysis/Budget/50/My/Hypervolume/"+algorithm+ ".txt");
