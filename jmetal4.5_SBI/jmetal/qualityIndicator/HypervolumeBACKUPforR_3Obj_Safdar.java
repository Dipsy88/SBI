 ...
 *           pp. 257-271, 1999.
 */
public class HypervolumeBACKUPforR_3Obj_Safdar {
...
private static String inFolderNSGAII = "/Users/Dipesh/OneDrive/Safdar/FUN 6";
private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Safdar/New";
...
// static String []  algorithmNameList_ = new String[] {"CELLDE","EA"};
  ...
  */
  public HypervolumeBACKUPforR_3Obj_Safdar() {
  ...
  public static void main(String args[]) throws Exception {
	  for (int algorithmRun=0;algorithmRun<algorithmNameList_.length;algorithmRun++){
			...
			for (int row=1;row<2;row++){			
				    ...
				    HypervolumeBACKUPforR_3Obj_Safdar qualityIndicator = new HypervolumeBACKUPforR_3Obj_Safdar();
...
//				    file.write(value +"\t" );
	...
	public static double [][] readFile(int row,String algorithm){		
		double [][] solutionFront = new double[500][3] ;
	    double [][] trueFront;
	    int counter;
