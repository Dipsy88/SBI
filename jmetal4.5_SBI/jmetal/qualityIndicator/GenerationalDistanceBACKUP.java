 ...
 *            Inst. Technol. (1998)
 */
public class GenerationalDistanceBACKUP {
...
//  static String [] algorithmNameList_ = new String[] {"ea", "nsgaii", "spea2", "cellde", "ibea", "mocell", "avm","rs"};
   ...
   */
  public GenerationalDistanceBACKUP() {
...
//    } // if
	  int numberObjectives = 5;	
	    ...
	    // STEP 1. Create an instance of Generational Distance
					    GenerationalDistanceBACKUP qualityIndicator = new GenerationalDistanceBACKUP();
...
//					    System.out.println(value);
	...
	public static void createFile(String algorithm) throws Exception{
		fileName = new File("/Users/Dipesh/OneDrive/Papers/ICST2015/Analysis/"+numberCases+"/GD/" + algorithm+ ".txt");
