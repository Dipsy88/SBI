...
public class QualityIndicatorBACKUP5_RAW {
	...
	int  numberCases = 900;
	public QualityIndicatorBACKUP5_RAW() {
		// TODO Auto-generated constructor stub
		
		 problemcount =75;
//		problemcount = 1456;
		 independentRuns_ = 100;
		algorithmNameList_ = new String[] {"smpso", "nsgaii", "spea2", "cellde", "ibea", "mocell", "avm"};
...
//			System.out.println(i);
	...
	private void generateReferenceFront(int problemIndex)
	{
		...
		String frontPath_ = "/Users/Dipesh/OneDrive/Papers/ICST2015/Analysis/RAW/"+numberCases+"/nondominated/"+problemIndex+ ".txt";
		...
		for (int algorithmIndex=0; algorithmIndex<algorithmNameList_.length; algorithmIndex++) {
			...
			for (int numRun=1; numRun<=independentRuns_; numRun++) {
				...
				outputParetoFrontFilePath = "/Users/Dipesh/OneDrive/Papers/ICST2015/Result/RAW/"+numberCases+"/"+ algorithmNameList_[algorithmIndex] +"/"+algorithmNameList_[algorithmIndex] + problemIndex + "_" + numRun;
...
//						resetFile(problemDirectory + "\\" + indicatorList_[indicatorIndex]);
	...
	public static void main(String[] args) throws IOException {
		...
		QualityIndicatorBACKUP5_RAW qi = new QualityIndicatorBACKUP5_RAW();
